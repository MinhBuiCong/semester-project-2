  ...
  if (cart) {
    Object.keys(cart).forEach((id) => {
      ...
      cartContainer.innerHTML += `<div class="cart-item">
                                    <div class="section-1">
                                      <img class="cart-product-image"src="${item.product.image[0].url}" alt="${item.product.name}"> 
                                    </div>
                                    <div class="section-2">
                                    ...
                                    <div class="section-4">
                                      <p class="cart-item-price">$${item.product.price *item.count}</p>                  
                                    </div>
                                    <div class="section-5">
                                      <button class="cart-item-remove" onclick="removeFromCart(${item.product.id})">X</button>                  
                                    </div>
                                  </div>`;
